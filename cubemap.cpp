...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "cubemap", NULL, NULL);
	if (window == NULL)
	{
	...
	Shader shader("cube_map_cubebox_vs.txt", "cube_map_cubebox_fs.txt");
	Shader skyShader("cubemap_vs.txt","cubemap_fs.txt");
