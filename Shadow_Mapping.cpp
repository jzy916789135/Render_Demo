...
int main()
{
	...
	Shader shader("shadow_mapping_vs.txt","shadow_mapping_fs.txt");
	Shader simpleDepthShader("3.1_shadow_mapping_depth_vs.txt","3.1_shadow_mapping_depth_fs.txt");
	Shader debugDepthQuad("3.1_debug_quad_vs.txt","3.1_debug_quad_fs.txt");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightProjection = glm::ortho(-10.f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);
