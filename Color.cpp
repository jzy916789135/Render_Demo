...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("1.vcolors.txt", "1.fcolors.txt");
    Shader lightCubeShader("1.vcolors.txt", "1.flight_cube.txt");
    ...
    glm::vec3 cubeLight[] = {
        ...
        glm::vec3(1.0f,  0.13f, 0.82f),
        glm::vec3(0.33f,  0.52f, 0.47f)
    };
    ...
    lightingShader.use();
    glUniform1i(glGetUniformLocation(lightingShader.ID, "material.dissuse"), 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.use();
        glUniform3f(glGetUniformLocation(lightingShader.ID, "viewPos"), camera.Position.x, camera.Position.y, camera.Position.z);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "dirLight.ambient"), 0.04f, 0.04f, 0.04f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "dirLight.diffuse"), 0.8f, 0.8, 0.8f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[0].ambient"), pointLightColors[0].x * 0.1f, pointLightColors[0].y * 0.1f, pointLightColors[0].z * 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[0].diffsue"), pointLightColors[0].x, pointLightColors[0].y, pointLightColors[0].z);
        ...
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[0].quadratic"), 0.032f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[1].ambient"), pointLightColors[1].x*0.1f , pointLightColors[1].y * 0.1f, pointLightColors[1].z * 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[1].diffsue"), pointLightColors[1].x, pointLightColors[1].y, pointLightColors[1].z);
        ...
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[1].linear"), 0.09f);
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[1].quadratic"), 0.032f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[2].ambient"), pointLightColors[2].x * 0.1f, pointLightColors[2].y * 0.1f, pointLightColors[2].z * 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[2].diffsue"), pointLightColors[2].x, pointLightColors[2].y, pointLightColors[2].z);
        ...
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[2].linear"), 0.09f);
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[2].quadratic"), 0.032f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[3].ambient"), pointLightColors[3].x * 0.1f, pointLightColors[3].y * 0.1f, pointLightColors[3].z * 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[3].diffsue"), pointLightColors[3].x, pointLightColors[3].y, pointLightColors[3].z);
        ...
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[3].linear"), 0.09f);
        glUniform1f(glGetUniformLocation(lightingShader.ID, "pointLights[3].quadratic"), 0.032f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "spotLight.ambient"), 0.5f, 0.8f, 0.95f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "spotLight.diffuse"), 0.5f, 0.8f, 0.95f);
        ...
        glUniform1f(glGetUniformLocation(lightingShader.ID, "spotLight.outerCutOff"), glm::cos(glm::radians(17.5f)));
        glUniform1f(glGetUniformLocation(lightingShader.ID, "spotLight.constant"), 1.0f);
        glUniform1f(glGetUniformLocation(lightingShader.ID, "spotLight.linear"), 0.09f);
        glUniform1f(glGetUniformLocation(lightingShader.ID, "spotLight.quadratic"), 0.032f);
        ...
        for (int i = 0; i < 4; i++)
        {
            glUniform3f(glGetUniformLocation(lightCubeShader.ID, "aColor"), cubeLight[i].x, cubeLight[i].y, cubeLight[i].z);
